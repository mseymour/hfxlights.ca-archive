<nav class="overlay-nav">
    ...
    <div class="overlay-nav__search filter" data-filter>
        <div class="filter__options">
            <button type="button" class="filter__option"><span class="sr-only">Search for places</span> Near Me</button>
            <form class="filter__option">
                <input class="filter__search" type="search" placeholder="Search" aria-label="Search for places by address">
